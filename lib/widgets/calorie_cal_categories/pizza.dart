...
*/
  ...
  calculateCalory() {
    ...
    sausageCal+hamCal+muttonCal+mayonnaiseCal+ketchupCal+tomatoCal+lettuceCal+onionCal;
  ...
  calculateCarbohydrete() {
    ...
    porkCarbs+sausageCarbs+hamCarbs+muttonCarbs+mayonnaiseCarbs+ketchupCarbs+tomatoCarbs+lettuceCarbs+
    onionCarbs;
  ...
  calculateFat() {
    ...
    sausageFat+hamFat+muttonFat+mayonnaiseFat+ketchupFat+tomatoFat+lettuceFat+onionFat;
